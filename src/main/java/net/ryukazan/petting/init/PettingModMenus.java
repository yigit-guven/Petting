...
public class PettingModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<PetConfigurationGUIMenu>> PET_CONFIGURATION_GUI = REGISTRY.register("pet_configuration_gui", () -> IMenuTypeExtension.create(PetConfigurationGUIMenu::new));
