...
public class EntitySettingsServer {
    public static void handleOpenRequest(ServerPlayer player, int entityId) {
        ...
        PettingMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> player),
            new SendPetSettingsPacket(entityId, sitstill, waiting, isTamed, attackIfOwnerAttacks, attackIfOwnerAttacked, attackIfSelfAttacked, damageOwner, ignoreWhistle, followDistance, teleportDistance, true, controlRightClick, controlShiftRightClick));
    }
    ...
    public static void applyUpdate(ServerPlayer player, int entityId, String key, String value) {
        ...
        PettingMod.PACKET_HANDLER.send(PacketDistributor.TRACKING_ENTITY.with(() -> entity),
            new SendPetSettingsPacket(entityId,
