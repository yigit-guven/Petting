...
public class FollowOwnerOrTeleport {
    ...
    private static class FollowOwnerOrTeleportForgeBusEvents {
        ...
        public static void onEntityTick(net.neoforged.neoforge.event.tick.EntityTickEvent.Pre event) {
            ...
            final net.minecraft.resources.ResourceLocation PETTING_STOP_ID = net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("petting", "petting_stop");
            ...
            if (data.contains("sitstill") && data.getBoolean("sitstill")) {
                ...
                if (speedAttribute != null && !speedAttribute.hasModifier(PETTING_STOP_ID)) {
                    speedAttribute.addTransientModifier(stopModifier);
                }
                if (flyingSpeedAttribute != null && !flyingSpeedAttribute.hasModifier(PETTING_STOP_ID)) {
